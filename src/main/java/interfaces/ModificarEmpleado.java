...
import client.CrearPuestoTrabajo_CB;
import client.ModificarEmpleadoClient;
import domain.PuestoTrabajo;
import static interfaces.RegistrarEmpleado.puestoTrabajoService;
...
public class ModificarEmpleado extends javax.swing.JFrame {
    ...
    public ModificarEmpleado() {
        ...
        MostrarPuestoTrabajo(cbx_PuestoTrabajo_ModificarEmpleado);
    }
    ...
    private void initComponents() {
        ...
        txt_Id_ModificarEmpleado = new javax.swing.JTextField();
        ...
        ck_Inactivo_ModificarEmpleado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ck_Inactivo_ModificarEmpleadoActionPerformed(evt);
            }
        });
        ...
        jLabel8.setText("Modificar datos del empleado:");
        ...
        txt_Id_ModificarEmpleado.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 2));
        txt_Id_ModificarEmpleado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_Id_ModificarEmpleadoActionPerformed(evt);
            }
        });
        jPanel2.add(txt_Id_ModificarEmpleado, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 10, 150, 30));

        jLabel15.setFont(new java.awt.Font("Nirmala UI", 1, 14)); // NOI18N
        jLabel15.setText("Codigo del Empleado:");
        jPanel2.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 10, -1, -1));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 0, 630, 640));
    ...
    private void ck_Activo_ModificarEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ck_Activo_ModificarEmpleadoActionPerformed
        ...
        if(ck_Activo_ModificarEmpleado.isSelected()){
            ck_Inactivo_ModificarEmpleado.setSelected(false);
        }
    ...
    private void btn_Modificar_ModificarEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_Modificar_ModificarEmpleadoActionPerformed
        ...
        new ModificarEmpleadoClient(this);
    ...
    private void ck_Inactivo_ModificarEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ck_Inactivo_ModificarEmpleadoActionPerformed
        
        if(ck_Inactivo_ModificarEmpleado.isSelected()){
            ck_Activo_ModificarEmpleado.setSelected(false);
        }
        
    }//GEN-LAST:event_ck_Inactivo_ModificarEmpleadoActionPerformed

    private void txt_Id_ModificarEmpleadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_Id_ModificarEmpleadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txt_Id_ModificarEmpleadoActionPerformed
    ...
    public javax.swing.JButton btn_Cancelar_ModificarEmpleado;
    public javax.swing.JButton btn_CrearPuesto_ModificarEmpleado;
    public javax.swing.JButton btn_Modificar_ModificarEmpleado;
    public javax.swing.JComboBox<String> cbx_PuestoTrabajo_ModificarEmpleado;
    public javax.swing.JComboBox<String> cbx_Sexo_ModificarEmpleado;
    public javax.swing.JCheckBox ck_Activo_ModificarEmpleado;
    public javax.swing.JCheckBox ck_Inactivo_ModificarEmpleado;
    ...
    public javax.swing.JTextField txt_Apellido_ModificarEmpleado;
    public javax.swing.JTextField txt_DNI_ModificarEmpleado;
    public javax.swing.JTextField txt_Id_ModificarEmpleado;
    public javax.swing.JTextField txt_Nombre_ModificarEmpleado;
    public javax.swing.JTextField txt_NumeroContacto_ModificarEmpleado;
    // End of variables declaration//GEN-END:variables

    
    CrearPuestoTrabajo_CB crearPuestoTrabajo_CB = new CrearPuestoTrabajo_CB();
    PuestoTrabajo puestoTrabajo = new PuestoTrabajo();

    private void MostrarPuestoTrabajo(JComboBox cbmx) {
        DefaultComboBoxModel combo = new DefaultComboBoxModel();
        
        cbmx.setModel(combo);
        
        PuestoTrabajo[] col = puestoTrabajoService.consultar();
        int col2 = col.length;
        ArrayList<PuestoTrabajo> puestoTrabajos = new ArrayList<>();
        
        for (int i = 1; i <= col2; i++) {

            PuestoTrabajo puestTrabajo = puestoTrabajoService.consultarPorId(i);
            if (puestTrabajo != null) {
                puestoTrabajos.add(puestTrabajo);
            }
        ...
        for (PuestoTrabajo puestoTrabajoCBMX : puestoTrabajos) {

            puestoTrabajo.setNombrePuesto(puestoTrabajoCBMX.getNombrePuesto());

            crearPuestoTrabajo_CB.AgregarPuestoTrabajo(puestoTrabajoCBMX);

            combo.addElement(puestoTrabajo.getNombrePuesto());
