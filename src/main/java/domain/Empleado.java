...
public class Empleado implements Comparable<Empleado>{
    ...
    //constructores
    public Empleado(Integer IdEmpleado, String codigo, String nombre, String apellido, String sexo, String dni, String numeroContacto, String estado, String puestoTrab) {
        this.IdEmpleado = IdEmpleado;
        this.codigo = codigo;
        this.nombre = nombre;
        this.apellido = apellido;
